...
# General Imports
from config import signal_positive_ticker
from config import signal_negative_ticker
from position import open_position_confirmation
from position import active_position_confirmation
from trade import manage_new_trades
from execute_trade import set_leverage
from close import close_all_positions
from zscore import get_latest_zscore
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # # Keep alive
        # # Removed WSS in favour of rather using REST API
