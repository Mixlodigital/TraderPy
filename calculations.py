from config import stop_loss_fail_safe
from config import ticker_1
from config import rounding_ticker_1
from config import rounding_ticker_2
from config import quantity_rounding_ticker_1
from config import quantity_rounding_ticker_2
import math
